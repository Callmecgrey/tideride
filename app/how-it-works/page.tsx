          ...
          <div className="grid grid-cols-1 gap-y-20 lg:grid-cols-2 lg:gap-x-16">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg ring-1 ring-border">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-black/0 flex items-end p-8">
                  <div className="text-white">
                    <h3 className="text-2xl font-bold">1. Schedule Pickup</h3>
                    <p className="mt-2 text-gray-200">Book your preferred time slot online</p>
                  </div>
                </div>
              </div>
              <div className="absolute -bottom-10 -right-10 bg-background rounded-2xl p-6 shadow-xl ring-1 ring-border">
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-lg ring-1 ring-border">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-black/0 flex items-end p-8">
                  <div className="text-white">
                    <h3 className="text-2xl font-bold">2. We Clean</h3>
                    <p className="mt-2 text-gray-200">Expert cleaning with premium products</p>
                  </div>
                </div>
              </div>
              <div className="absolute -bottom-10 -right-10 bg-background rounded-2xl p-6 shadow-xl ring-1 ring-border">
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-lg ring-1 ring-border">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-black/0 flex items-end p-8">
                  <div className="text-white">
                    <h3 className="text-2xl font-bold">3. Quality Check</h3>
                    <p className="mt-2 text-gray-200">Thorough inspection and perfect folding</p>
                  </div>
                </div>
              </div>
              <div className="absolute -bottom-10 -right-10 bg-background rounded-2xl p-6 shadow-xl ring-1 ring-border">
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-lg ring-1 ring-border">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-black/0 flex items-end p-8">
                  <div className="text-white">
                    <h3 className="text-2xl font-bold">4. Fast Delivery</h3>
                    <p className="mt-2 text-gray-200">Right to your doorstep within 24 hours</p>
                  </div>
                </div>
              </div>
              <div className="absolute -bottom-10 -right-10 bg-background rounded-2xl p-6 shadow-xl ring-1 ring-border">
