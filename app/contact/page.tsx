      ...
      <section className="relative pt-20 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 sm:pt-24 pb-16 sm:pb-20">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight lg:text-6xl">Get in Touch</h1>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-y-12 lg:grid-cols-2 lg:gap-x-8">
            <div>
              ...
              <dl className="mt-8 sm:mt-10 space-y-4 text-base leading-7 text-muted-foreground">
                <div className="flex gap-x-4">
                  <dt className="flex-none">
                    <span className="sr-only">Telephone</span>
                    <Phone className="h-6 w-6 sm:h-7 sm:w-6 text-primary" aria-hidden="true" />
                  </dt>
                  <dd>
                ...
                <div className="flex gap-x-4">
                  <dt className="flex-none">
                    ...
                    <Mail className="h-6 w-6 sm:h-7 sm:w-6 text-primary" aria-hidden="true" />
                  </dt>
                  <dd>
                ...
                <div className="flex gap-x-4">
                  <dt className="flex-none">
                    ...
                    <Clock className="h-6 w-6 sm:h-7 sm:w-6 text-primary" aria-hidden="true" />
                  </dt>
                  <dd>
                    Monday - Sunday<br />
                    7:00 AM - 9:00 PM
            ...
            <form onSubmit={handleSubmit} className="bg-background rounded-2xl shadow-xl ring-1 ring-border p-6 sm:p-8">
