      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 py-16 sm:py-24">
        ...
        <div className="mt-8 space-y-6 sm:space-y-8 text-base sm:text-lg text-muted-foreground">
          <section>
            ...
            <p>
              Cookies are small text files that are placed on your computer or mobile device when you visit our website. They help us make your experience better while you use our site.
            </p>
          </section>

          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-4">2. How We Use Cookies</h2>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p>Track your visits across websites to deliver relevant advertisements.</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-4">4. Managing Cookies</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-4">5. Third-Party Cookies</h2>
            <p>
              Some cookies are placed by third-party services that appear on our pages. We do not control these cookies and recommend reviewing their privacy policies.
            </p>
          </section>

          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-4">6. Updates to This Policy</h2>
            <p>
              We may update this Cookie Policy to reflect changes in our practices. We encourage you to periodically review this page for the latest information.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              If you have questions about our use of cookies, please contact us at privacy@tidyride.com.
            </p>
          </section>
        </div>
      </div>
