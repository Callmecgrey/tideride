        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-muted-foreground">
              Making laundry day the easiest part of your week with professional service and convenient delivery.
            </p>
            <div className="space-y-3">
              <div className="flex items-center gap-x-3">
                <Phone className="h-5 w-5 text-primary" />
                <a href="tel:+1 (555) 234-5678" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  +1 (555) 234-5678
                </a>
              </div>
              <div className="flex items-center gap-x-3">
                <Mail className="h-5 w-5 text-primary" />
                <a href="mailto:hello@tidyride.com" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  hello@tidyride.com
                </a>
              </div>
            </div>
        ...
        <div className="mt-16 border-t border-border pt-8 sm:mt-20 lg:mt-24">
          <div className="flex flex-col items-center gap-8">
            ...
            <p className="text-xs leading-5 text-muted-foreground">
              &copy; {new Date().getFullYear()} TidyRide. All rights reserved.
            </p>
          </div>
        </div>
      </div>
